  ...
  <section class="flex flex-col items-center justify-center px-4 mb-8">
    ...
    <form class="w-full card-baru" @submit.prevent="createFrontoffice">
      ...
      <div class="grid grid-cols-2 gap-4">
          <div class="form-group">
     <label for="" class="text-grey">Muzakki &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      <!-- <router-link to="muzaki/create.vue" class="text-blue-500 hover:underline">
      Tambah Muzakki
    </router-link> -->
    <NuxtLink
                  :to="{
  ...
  methods: {
    ...
    async fetchUrut() {
      ...
      if (urut.toString().length < 4){
        ...
        this.frontoffice.nobuktipenerima = this.noUrutin
      }else{
        this.noUrutin = (parseInt(noUrut.data.result.data[0].nobuktipenerima.substring(0,4)) + 1) + "BRV-FO";
        this.frontoffice.nobuktipenerima = this.noUrutin
      }
    },
